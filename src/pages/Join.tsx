...
import { Stethoscope, GraduationCap, Building2, ArrowLeft } from 'lucide-react';
        ...
        <div className="relative z-10 text-center max-w-md">
          <div className="mb-8 flex justify-center">
            <Link to="/" className="inline-block hover:opacity-95 transition-opacity">
              <AyushlineLogo size="xl" variant="gold" showTagline={true} />
            </Link>
          </div>
          <h2 className="text-3xl font-display font-bold mb-4 text-ayush-cream">Holistic Health, Holistic Life.</h2>
          <p className="font-body text-ayush-ivory/80 text-base">
            A universal platform for traditional AYUSH healthcare and holistic wisdom.
          </p>
        </div>
      </div>
          ...
          {!isSignIn && !isForgotPassword && !isSignUp && (
            <div className="mb-8 text-center md:text-left">
              <div className="md:hidden mb-6 flex justify-center">
                <Link to="/" className="inline-block hover:opacity-95 transition-opacity">
                  <AyushlineLogo size="lg" variant="dark" />
                </Link>
              </div>
              <h1 className="text-3xl sm:text-4xl font-display font-bold text-ayush-forest mb-2">
                Join Professionally
              </h1>
              <p className="text-ayush-charcoal/70 font-body">Select your role to create your verified professional account, or login below.</p>
            </div>
          )}
