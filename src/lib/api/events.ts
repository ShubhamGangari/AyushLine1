...
export const fallbackEvents: EventItem[] = [
  { id: '1', title: 'Global Ayurveda Summit 2026', type: 'Seminar', event_date: 'August 15, 2026', date: 'August 15, 2026', location: 'New Delhi, India (Hybrid)', attendees: 500, description: 'A 3-day global summit bringing together leading Ayurvedic practitioners to discuss modern integrations of ancient practices.', banner_url: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=800&auto=format&fit=crop&q=80', status: 'approved' },
  { id: '2', title: 'Therapeutic Yoga Workshop', type: 'Workshop', event_date: 'September 5, 2026', date: 'September 5, 2026', location: 'Online via Zoom', attendees: 150, description: 'An interactive workshop focusing on specific asanas for stress relief and chronic pain management. Open to all levels.', banner_url: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=800&auto=format&fit=crop&q=80', status: 'approved' },
  { id: '3', title: 'Homeopathy in Pediatrics', type: 'Webinar', event_date: 'September 20, 2026', date: 'September 20, 2026', location: 'Online', attendees: 300, description: 'A dedicated webinar for practitioners to learn safe homeopathic approaches for common pediatric illnesses.', banner_url: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&auto=format&fit=crop&q=80', status: 'approved' }
];
