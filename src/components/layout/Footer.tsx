    ...
    <footer className="bg-ayush-charcoal text-ayush-cream pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <h4 className="font-display text-lg font-semibold mb-4 text-ayush-ivory">Quick Links</h4>
            <ul className="space-y-2 font-ui text-sm">
              <li><Link to="/" className="text-ayush-ivory/80 hover:text-ayush-gold transition-colors">Home</Link></li>
              <li><Link to="/consult" className="text-ayush-ivory/80 hover:text-ayush-gold transition-colors">Consultation</Link></li>
              <li><Link to="/whats-new" className="text-ayush-ivory/80 hover:text-ayush-gold transition-colors">What's New</Link></li>
              <li><Link to="/about" className="text-ayush-ivory/80 hover:text-ayush-gold transition-colors">About Us</Link></li>
              <li><Link to="/join" className="text-ayush-ivory/80 hover:text-ayush-gold transition-colors">Join Professionally</Link></li>
        ...
        <div className="mt-4 pt-4 border-t border-ayush-ivory/10 text-center text-xs font-ui text-ayush-ivory/40">
          Ayushline® is a registered trademark. All content on this platform is protected.
        </div>
      </div>
    </footer>
  );
