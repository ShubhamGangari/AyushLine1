        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-5 text-center md:text-left">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-display font-bold text-white tracking-wide drop-shadow-xs">{name || 'AYUSH Scholar'}</h1>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-ayush-charcoal/10">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link to="/whats-new" className="text-sm font-bold font-ui text-ayush-forest hover:text-ayush-gold">
                  Browse All →
                </Link>
              </div>
              {eventsLoading ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {events.slice(0, 4).map((evt) => (
                    <div key={evt.id} className="bg-ayush-cream rounded-2xl p-4 border border-ayush-charcoal/5 flex flex-col justify-between space-y-2">
                      ...
                      <Link to="/whats-new" className="text-sm font-bold text-ayush-forest hover:underline pt-2 border-t border-ayush-charcoal/10 inline-block">
                        View Event Details
                      </Link>
                    </div>
                  ))}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-ayush-forest rounded-3xl p-6 text-white shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <Link to="/whats-new" className="flex items-center gap-3 px-4 py-3.5 bg-white/10 rounded-xl hover:bg-white/20 transition-colors text-base font-ui font-semibold">
                  <Star className="w-5 h-5 text-ayush-gold" /> What's New Portal
                </Link>
              </div>
            </div>
